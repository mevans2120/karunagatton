      ...
      <div className="page-content">
        ...
        <section className="relative min-h-[50vh] flex items-center bg-primary text-white overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20 text-left py-24 pt-48">
            <Heading level={1} variant="hero-sm" className="mb-8">Empowerment Ceremony</Heading>
          ...
          <svg className="absolute bottom-0 left-0 w-full z-30 hero-wave-offerings" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" style={{ marginBottom: '-1px' }}>
